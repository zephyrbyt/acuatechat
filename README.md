...
You can still communicate with users who are using the stable version of Acuate.chat on the canary version, Any other users will not be able to see any of the experimental features.
...
1. Head to the [Releases](https://github.com/zephyrbyt/acuatechat/releases) tab
